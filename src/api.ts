...
export async function generatePodcastWithAudio({
  ...
  let prompt = `ช่วยเขียนสคริปต์ podcast ภาษาไทย หัวข้อ "${topic}" กรุณาสร้างสคริปต์พอดแคสต์สำหรับผู้พูดคนเดียว จากนั้นให้เขียนเนื้อหาในลักษณะคำพูดต่อเนื่อง อธิบายเนื้อหาให้ชัดเจน ครอบคลุมหัวข้อที่กำหนด โดยห้ามใส่เสียงประกอบ คำอธิบายฉาก หรือข้อความในวงเล็บ เช่น (เสียง...) หรือ [เสียง...] หรือคำอธิบายฉากใดๆ ห้ามใช้ ##, *, ,/n หรือ [] เน้นให้เป็นประโยคที่สามารถนำไปสร้างเสียงพูดต่อเนื่องด้วย voice bot ได้ทันที${rolePrompt}`;
